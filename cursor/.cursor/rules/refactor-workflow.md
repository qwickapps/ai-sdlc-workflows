---
description: Code refactoring workflow with impact analysis. Use when restructuring code.
alwaysApply: false
---

# Refactor Workflow

When this rule is activated, follow the refactoring workflow with impact analysis.
