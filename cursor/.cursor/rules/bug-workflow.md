---
description: Bug investigation and fix workflow. Use when fixing bugs or issues.
alwaysApply: false
---

# Bug Fix Workflow

When this rule is activated, follow the bug investigation and fix workflow.
